...
@section('content')
    <div class="content">
            ...
            <div class="my-auto mb-2">
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">HS code</li>
                    </ol>
                </nav>
            </div>
                        ...
                        <tbody>
                            @foreach ($hsCode as $item)
                                <tr>
                                    ...
                                    <td>                                       
										<a href="#" class="me-2 edit-HS code" data-bs-toggle="modal"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Add HS code</h4>
                        <button type="button" class="btn-close custom-btn-close" data-bs-dismiss="modal"
                            aria-label="Close">
                            <i class="ti ti-x"></i>
                        </button>
                    </div>
                    <form action="{{ route('hs-codes.store') }}" method="POST">
                        @csrf
        ...
        <!-- Edit -->
        <div class="modal fade" id="edit_HS code">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form id="HS codeForm" action="" method="POST">
                        @csrf
                        <input type="hidden" name="id" id="HS code_id">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label">HS code Name<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="HS code_name" name="name"
