    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-2">
            ...
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                <div class="mb-2">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#add_territory"
                        ...
                        <tbody>
                            @foreach ($territory as $item)
                                <tr>
                                    ...
                                    <td>
										<a href="#" class="me-2 edit-Territory" data-bs-toggle="modal"
											data-bs-target="#edit_Territory" data-id="{{ $item->id }}"
											data-name="{{ $item->name }}">
        ...
        <!-- Add -->
        <div class="modal fade" id="add_territory">
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Add Territory</h4>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="code" placeholder="Territory">
                                    </div>
                                </div>
								<div class="col">
                                    <div class="mb-3">
        ...
        <!-- Edit -->
        <div class="modal fade" id="edit_Territory">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Edit Territory</h4>
                        <button type="button" class="btn-close custom-btn-close" data-bs-dismiss="modal"
                            aria-label="Close">
                            <i class="ti ti-x"></i>
                        </button>
                    ...
                    <form id="TerritoryForm" action="" method="POST">
                        @csrf
                        <input type="hidden" name="id" id="Territory_id">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label">Territory Name<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="Territory_name" name="name"
...
@section('js')
    <script>
		document.querySelectorAll('.edit-Territory').forEach(btn => {
			btn.addEventListener('click', () => {
				document.getElementById('Territory_id').value = btn.dataset.id;
				document.getElementById('Territory_name').value = btn.dataset.name;
			});
		});
    </script>
@endsection
