                        ...
                        <tbody>
                            @foreach ($country as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="me-2 edit-Country" data-bs-toggle="modal"
                                            data-bs-target="#edit_Country" data-id="{{ $item->id }}"
                                            data-name="{{ $item->name }}">
    ...
    <script>
        document.querySelectorAll('.edit-Country').forEach(btn => {
            btn.addEventListener('click', () => {
                document.getElementById('Country_id').value = btn.dataset.id;
                document.getElementById('Country_name').value = btn.dataset.name;
            });
        });
    </script>
@endsection
