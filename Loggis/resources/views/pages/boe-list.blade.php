    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            <div class="my-auto mb-2">
                <h2 class="mb-1">Bill of Entry</h2>
            </div>
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                <a href="{{ url('boe-create') }}" class="btn btn-primary d-flex align-items-center me-2">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            @php
                                ...
                                $faker = Faker::create();
                                $boeTypes = ['Re-Export', 'Free Zone', 'Mainland', 'Temporary'];
                                $certificates = ['GCC', 'FTA', 'None'];
                                $statuses = ['Open', 'Draft', 'Posted', 'Cancelled'];
                            @endphp
                            ...
                            @for ($i = 1; $i <= 15; $i++)
                                <tr>
                                    ...
                                    <td>BOE-{{ str_pad($i, 4, '0', STR_PAD_LEFT) }}</td>
                                    <td>{{ strtoupper($faker->bothify('CUST-###??')) }}</td>
                                    <td>{{ $faker->date('Y-m-d') }}</td>
                                    <td>SHIP-{{ $faker->unique()->numberBetween(1000, 9999) }}</td>
                                    <td>{{ $faker->randomElement($boeTypes) }}</td>
                                    <td>{{ $faker->company }}</td>
                                    <td>{{ $faker->city }}</td>
                                    <td>{{ $faker->city }}</td>
                                    <td>{{ $faker->randomElement($certificates) }}</td>
                                    <td>
                                        <span
                                            class="badge badge-{{ $faker->randomElement(['success', 'danger', 'warning', 'info']) }} d-inline-flex align-items-center badge-xs">
                                            <i class="ti ti-point-filled me-1"></i>{{ $faker->randomElement($statuses) }}
                                        </span>
                                    </td>
                                    <td>
                                        <div class="action-icon d-inline-flex">
                                            <a href="javascript:void(0);" class="me-2"><i class="ti ti-eye"></i></a>
                                            <a href="javascript:void(0);"><i class="ti ti-download"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endfor
                            ...
                            <ul class="nav nav-underline" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="address-tab" data-bs-toggle="tab" data-bs-target="#address"
                                        type="button" role="tab" aria-selected="false">Organization</button>
                                </li>
                            </ul>
                        </div>
