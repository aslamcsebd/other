    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            <div class="my-auto mb-2">
                <h2 class="mb-1">Customer group</h2>
            </div>
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            @php
                                ...
                                $faker = Faker::create();
                                $terms = ['Cash', 'Net 7', 'Net 15', 'Net 30', 'Net 60'];
                                $taxGroups = ['VAT 5%', 'VAT 10%', 'GST', 'No Tax'];
                            ...
                            @for ($i = 1; $i <= 15; $i++)
                                ...
                                <tr>
                                    ...
                                    <td>MAN-{{ str_pad($i, 4, '0', STR_PAD_LEFT) }}</td>
                                    <td>{{ $faker->name }}</td>
                                    <td>{{ $faker->randomElement($terms) }}</td>
                                    <td>{{ $faker->randomElement($taxGroups) }}</td>
                                    <td>
                                        <span
                                            class="badge badge-{{ $status === 'Active' ? 'success' : 'danger' }} d-inline-flex align-items-center badge-xs">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="manual_id"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="tax_group">
