                        ...
                        <tbody>
                            ...
                            @for ($i = 1; $i <= 15; $i++)
                                <tr>
                                    ...
                                    <td>{{ $i }}</td>
                                    <td>{{ strtoupper($faker->lexify('TC-??')) }}</td>
                                    <td>{{ $faker->city }}</td>
                                    <td>
                    ...
                    <form action="clients.html">
                        <div class="modal-body pb-0 ">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Territory Code <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="territory_name"
