    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            <div class="my-auto mb-2">
                <h2 class="mb-1">Term of payment</h2>
            </div>
                ...
                <div class="custom-datatable-filter table-responsive">
                    <table class="table datatable">
                        ...
                        <tbody>
                            ...
                            @for ($i = 1; $i <= 15; $i++)
                                @php
                                    $default = $faker->randomElement($defaultTerms);
                                @endphp
                                <tr>
                                    <td>
                                        <div class="form-check form-check-md">
                                    ...
                                    <td>{{ $faker->randomElement($months) }}</td>
                                    <td>{{ $faker->numberBetween(1, 31) }}</td>
                                    <td>
                                        <span
                                            class="badge badge-{{ $default === 'Yes' ? 'success' : 'danger' }} d-inline-flex align-items-center badge-xs">
                    ...
                    <form action="clients.html">
                        <div class="modal-body pb-0 ">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            <input type="radio" class="btn-check" name="payment_method" id="net"
                                                value="Net" autocomplete="off">
                                            <label class="btn btn-outline-primary" for="net">Net</label>

                                            <input type="radio" class="btn-check" name="payment_method" id="current"
                                                value="Current Month" autocomplete="off">
                                            ...
                                            <input type="radio" class="btn-check" name="payment_method" id="cod"
                                                value="Cash on Delivery" autocomplete="off">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Default Term of Payment <span
                                                class="text-danger">*</span></label>
                                        <div class="d-flex gap-2">
                                            <input type="radio" class="btn-check" name="default_term" id="yes"
                                                value="Yes" autocomplete="off">
                                            <label class="btn btn-outline-success" for="yes">Yes</label>

                                            <input type="radio" class="btn-check" name="default_term" id="no"
