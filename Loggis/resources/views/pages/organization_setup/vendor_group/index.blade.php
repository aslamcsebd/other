                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            @php
                                ...
                                $faker = Faker::create();
                                $terms = ['Net 15', 'Net 30', 'Current Month', 'Cash on Delivery'];
                                $taxGroups = ['VAT 5%', 'VAT 10%', 'GST 18%', 'No Tax'];
                            ...
                            @for ($i = 1; $i <= 15; $i++)
                                <tr>
                                    ...
                                    <td>
                                        @php $status = $faker->randomElement($statuses); @endphp
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="term_of_payment"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="tax_group">
