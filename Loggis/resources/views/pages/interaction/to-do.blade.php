        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            ...
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                <div class="d-flex align-items-center border rounded p-1 me-2">
                    <a href="todo-list.html" class="btn btn-icon btn-sm"><i class="ti ti-list-tree"></i></a>
                    <a href="todo.html" class="btn btn-icon btn-sm active bg-primary text-white"><i
        ...
        <div class="card">
            <div class="card-body">
                <div class="row gy-3 mb-3">
                    ...
                    <div class="col-sm-8">
                        <div class="d-flex align-items-center justify-content-end">
                            <p class="mb-0 me-3 pe-3 border-end fs-14">Total Task : <span class="text-dark">
                                    55 </span></p>
                            ...
                            <ul class="nav nav-pills border d-inline-flex p-1 rounded bg-light todo-tabs" id="pills-tab"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        ...
                                        aria-selected="false">High</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link btn btn-sm btn-icon py-3 d-flex align-items-center justify-content-center w-auto"
                                    ...
                                    <div class="col-lg-8 col-sm-6">
                                        <div class="d-flex align-items-center justify-content-sm-end">
                                            <a href="#" class="btn btn-light me-2" data-bs-toggle="modal"
                                                data-bs-target="#add_todo"><i class="ti ti-circle-plus me-2"></i>Add
                                                New</a>
                                            <a href="#" class="btn btn-outline-light border">See All
                                                    ...
                                                    <div class="col-lg-6 col-md-7">
                                                        <div
                                                            ...
                                                            <div class="strike-info">
                                                                <h4 class="fs-14">Finalize project proposal
                                                                </h4>
                                                            </div>
                                                            <span
                ...
                <div class="text-center">
                    <a href="#" class="btn btn-primary"><i class="ti ti-loader me-2"></i>Load
                        More</a>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="todo.html" class="btn btn-danger">Yes, Delete</a>
                    </div>
                </div>
            </div>
        </div>
