                                ...
                                <div class="chat-list">
                                    <a href="chat.html" class="chat-user-list">
                                        <div class="avatar avatar-lg online me-2">
                                            <img src="{{ asset('img/user.jpg') }}" class="rounded-circle"
                                                alt="image">
                                        </div>
                    ...
                    <div class="chat-header">
                        <div class="user-details">
                            ...
                            <div class="avatar avatar-lg online flex-shrink-0">
                                <img src="{{ asset('img/user.jpg') }}" class="rounded-circle" alt="image">
                            </div>
                    ...
                    <div class="chat-body chat-page-group slimscroll">
                        <div class="messages">
                            ...
                            <div class="chats chats-right">
                                ...
                                <div class="chat-avatar">
                                    <img src="{{ asset('img/user.jpg') }}" class="rounded-circle dreams_chat"
                                        alt="image">
                                </div>
                            </div>
                            <div class="chats">
