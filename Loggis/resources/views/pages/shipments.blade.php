        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <!-- Import/Export/Transit/Transfer -->
                            <div class="col mb-3">
                            ...
                            <div class="col mb-3">
                                ...
                                <select class="form-control">
                                    ...
                                    <option value="1">ABC Imports Ltd</option>
                                    <option value="2">Global Traders Pvt</option>
                                    <option value="3">Oceanic Logistics</option>
                                    <option value="4">Sunrise Enterprises</option>
                                    <option value="5">Evergreen Shippers</option>
                                </select>
                            </div>
                            ...
                            <div class="col mb-3">
                                ...
                                <select class="form-control">
                                    ...
                                    <option value="101">TransWorld Shipping</option>
                                    <option value="102">BlueSea Freight Forwarders</option>
                                    <option value="103">Skyline Cargo Services</option>
                                    <option value="104">FastTrack Logistics</option>
                                    <option value="105">GlobalLink Agency</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-10 mb-3">
                                ...
                                <select class="form-control" id="sender_address_id" name="sender_address_id" disabled>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-10 mb-3">
                                ...
                                <select class="form-control" id="recipient_address_id" name="recipient_address_id"
                                    disabled>
                            ...
                            <table class="table datatable">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th>Preferential Certificate</th>
                                        <th>Status</th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <!-- AWB/BOL -->
                            <div class="col-md-3 mb-3">
                                <label class="form-label">AWB / BOL</label>
                                <input type="file" class="form-control">
                            </div>

                            <!-- Cert. of Origin -->
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Cert. of Origin</label>
                                <input type="file" class="form-control">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Shipment No.">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Declaration Number">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Delivery Date & Address</label>
                                        <input type="text" class="form-control" placeholder="Delivery Date & Address">
                                    </div>
                                    <div class="col-md-4 mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Original Load Port">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Port of Load</label>
                                        <input type="text" class="form-control" placeholder="Port of Load">
                                    </div>
                                    <div class="col-md-4 mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Gross Weight">
                                    </div>
                                    <div class="col-md-4 mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Shipping Marks">
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <!-- Charges ID -->
                            <div class="col-md-2 mb-3">
                                <label class="form-label">Charges ID</label>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Basis">
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-primary">Add Charge</button>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label class="form-label">Charges List</label>
                                <table class="table table-bordered table-sm">
                                    <thead class="table-light">
                                        <tr>
                                            <th>#</th>
            ...
            <div class="row justify-content-center mb-4">
                <button class="btn btn-success col-md-3">Save now</button>
            </div>
        </div>
...
@section('js')
    ...
    <script>
        $(function() {
            function setupAutocomplete(inputSelector, addressSelector, oppositeInputSelector, addButtonSelector) {
                $(inputSelector).autocomplete({
                    source: function(request, response) {
                        let oppositeId = $(oppositeInputSelector).data('user-id') || '';
                        $.get("{{ route('search.user') }}", {
                            q: request.term,
                            exclude_id: oppositeId
                        }, function(data) {
                            response($.map(data, function(item) {
                                return {
                                    label: item.name+ " [" +item.email+ "] [" +item.full_number+ "]",
                                    value: item.name,
                                    id: item.id
                                };
                            }));
                    ...
                    select: function(event, ui) {
                        ...
                        $(inputSelector).data('user-id', ui.item.id);

                        // enable address select & add button
                        $(addressSelector + ", " + addButtonSelector).prop('disabled', false);

                        // load addresses for selected user
                        $.get("{{ url('/get-addresses') }}/" + ui.item.id, function(addresses) {
                            let options = '<option value="">Select address</option>';
                            $.each(addresses, function(i, addr) {
                                options += `<option value="${addr.id}">
                            ${addr.address}, ${addr.city}, ${addr.state}
                        </option>`;
                            });
                            $(addressSelector).html(options).trigger(
                            'change'); // refresh select2 if using it
                        });
                    }
                });
            }

            // Bind autocomplete for both sender & recipient
            setupAutocomplete('#sender_id', '#sender_address_id', '#recipient_id', '#add_address_sender');
            setupAutocomplete('#recipient_id', '#recipient_address_id', '#sender_id', '#add_address_recipient');
