                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card bg-linear-gradiant border-white border-2 overlay-bg-3 position-relative">
                            <div class="card-body">
                                ...
                                <p class="fw-medium fs-13"><span class="text-danger fs-12"><i
                                            class="ti ti-arrow-wave-right-up me-1"></i>-6.01% </span> from last week</p>
                            </div>
                        </div>
                        <div class="card bg-linear-gradiant border-white border-2 overlay-bg-3 position-relative">
                            <div class="card-body">
                                ...
                                <p class="fw-medium fs-13"><span class="text-danger fs-12"><i
                                            class="ti ti-arrow-wave-right-up me-1"></i>-3.22% </span> from last week</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);"
                                            ...
                                            <img src="{{ asset('img/user.jpg') }}" class="w-auto h-auto"
                                                alt="Img">
                                        </a>
                                        <div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-nowrap dashboard-table mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <h6 class="fw-medium"><a href="deals-details.html">Collins</a></h6>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <h6 class="fw-medium"><a href="deals-details.html">Adams</a></h6>
                                        </td>
                                        <td>Contact Made</td>
                                        <td>
                                            $8,40,000
                                    ...
                                    <tr>
                                        <td>
                                            <h6 class="fw-medium"><a href="deals-details.html">Schumm</a></h6>
                                        </td>
                                        <td>Quality To Buy</td>
                                        <td>
                                            $6,10,000
                                    ...
                                    <tr>
                                        <td>
                                            <h6 class="fw-medium"><a href="deals-details.html">Wisozk</a></h6>
                                        </td>
                                        <td>Presentation</td>
                                        <td>
                                            $4,70,000
