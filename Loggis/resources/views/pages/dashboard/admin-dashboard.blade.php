...
@section('content')
    <div class="content">
        ...
        @php
            ...
            $activeBranch = $branches->find(session('branch_id'));
        @endphp
        ...
        <h5>Branch: {{ $activeBranch->name ?? 'N/A' }}</h5>     

        <p>Total user for {{ $activeBranch->name ?? 'N/A' }}: {{ $activeBranch->data }}</p> --}}
            ...
            <tbody>
                @foreach ($companies as $company)
                    @foreach ($company->branches as $branch)
                        <tr @if ($branch->id == $activeBranchId) class="table-success" @endif>
                            <td>{{ $company->name }}</td>
                            <td>{{ $branch->name }}</td>                            
							<td>{{ $branch->data }}</td>
                            <td>
                            ...
                            <td>
                                @if ($branch->id == $activeBranchId)
									<button class="btn btn-success btn-sm" disabled>Current</button>
								@elseif ($branch->company_id == auth()->user()->company_id)
									<a href="{{ route('switch.branch', $branch->id) }}" class="btn btn-outline-primary btn-sm">
										Switch
									</a>
								@endif
                            </td>
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center overflow-hidden">
                                ...
                                <a href="employee-details.html" class="avatar avatar-md me-2">
                                    <img src="{{ asset('img/user.jpg') }}" class="rounded-circle border border-white"
                                        alt="img">
                                </a>
                                <div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="avatar-list-stacked avatar-group-sm mb-2">
                                    <span class="avatar avatar-rounded">
                                        <img class="border border-white" src="{{ asset('img/user.jpg') }}"
                                            alt="img">
                                    </span>
                                    <span class="avatar avatar-rounded">
                                        <img class="border border-white" src="{{ asset('img/user.jpg') }}"
                                    ...
                                    <span class="avatar avatar-rounded">
                                        <img src="{{ asset('img/user.jpg') }}" alt="img">
                                    </span>
                                    <span class="avatar avatar-rounded">
                                        <img src="{{ asset('img/user.jpg') }}" alt="img">
                                    </span>
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('img/user.jpg') }}" class="rounded-circle border border-2"
                                            alt="img">
                                    </a>
                                    <div class="ms-2">
                        ...
                        <ul class="nav nav-tabs tab-style-1 nav-justified d-sm-flex d-block p-0 mb-4" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link fw-medium active" data-bs-toggle="tab" data-bs-target="#applicants"
                                    href="#applicants" aria-selected="false" tabindex="-1"
                                    role="tab">Applicants</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade" id="openings">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2 overflow-hidden">
                                            <p class="text-dark fw-medium text-truncate mb-0"><a
                                                    href="javascript:void(0);">Senior Laravel Developer</a>
                                            </p>
                            ...
                            <div class="tab-pane fade show active" id="applicants">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center">
                                        <a href="#" class="avatar overflow-hidden flex-shrink-0">
                                            <img src="{{ asset('img/user.jpg') }}" class="img-fluid rounded-circle"
                                                alt="img">
                                        </a>
                                        <div class="ms-2 overflow-hidden">
                                            ...
                                            <span class="fs-13 d-inline-flex align-items-center">Exp : 5+
                                                Years<i class="ti ti-circle-filled fs-4 mx-2 text-primary"></i>USA</span>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2 overflow-hidden">
                                            <p class="text-dark fw-medium text-truncate mb-0"><a href="#">Anthony
                                                    Lewis</a></p>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2 overflow-hidden">
                                            <p class="text-dark fw-medium text-truncate mb-0"><a href="#">Stephan
                                                    Peralt</a></p>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center todo-item border p-2 br-5 mb-2">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label fw-medium" for="todo1">Add
                                    Holidays</label>
                            </div>
                        </div>
                        <div class="d-flex align-items-center todo-item border p-2 br-5 mb-2">
                        ...
                        <div class="d-flex align-items-center todo-item border p-2 br-5 mb-0">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label fw-medium" for="todo6">Add Policy for
                                    Increment </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td><a href="project-details.html" class="link-default">PRO-001</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><a href="project-details.html" class="link-default">PRO-002</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><a href="project-details.html" class="link-default">PRO-003</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><a href="project-details.html" class="link-default">PRO-004</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><a href="project-details.html" class="link-default">PRO-005</a>
                                        </td>
                                        <td>
                                            <h6 class="fw-medium"><a href="project-details.html">Travel
                                    ...
                                    <tr>
                                        <td><a href="project-details.html" class="link-default">PRO-006</a>
                                        </td>
                                        <td>
                                            <h6 class="fw-medium"><a href="project-details.html">Service
                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body">
                        <div class="bg-light p-3 br-5 mb-4">
                            ...
                            <div class="d-flex align-items-center flex-wrap">
                                <p class="fs-13 mb-1 me-2"><i class="ti ti-calendar-event me-2"></i>Thu, 15
                                    Feb 2025</p>
                                <p class="fs-13 mb-1"><i class="ti ti-clock-hour-11 me-2"></i>01:00 PM -
                                    02:20 PM</p>
                            </div>
                        ...
                        <div class="bg-light p-3 br-5 mb-0">
                            ...
                            <div class="d-flex align-items-center flex-wrap">
                                <p class="fs-13 mb-1 me-2"><i class="ti ti-calendar-event me-2"></i>Thu, 15
                                    Feb 2025</p>
                                <p class="fs-13 mb-1"><i class="ti ti-clock-hour-11 me-2"></i>02:00 PM -
                                    04:20 PM</p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between border-top mt-2 pt-3">
                                <div class="avatar-list-stacked avatar-group-sm">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="d-flex align-items-center w-100">
                                    <a href="javscript:void(0);" class="avatar  flex-shrink-0">
                                        <img src="{{ asset('img/user.jpg') }}" class="rounded-circle" alt="img">
                                    </a>
