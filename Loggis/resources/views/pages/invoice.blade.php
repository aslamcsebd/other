                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            @php
                                ...
                                $faker = Faker::create();
                                $invoiceTypes = ['Sales', 'Purchase', 'Proforma', 'Credit Note'];
                                $statuses = ['Draft', 'Invoiced', 'Paid', 'Cancelled'];
                            @endphp
                            ...
                            @for ($i = 1; $i <= 15; $i++)
                                ...
                                <tr>
                                    ...
                                    <td>INV-{{ str_pad($i, 4, '0', STR_PAD_LEFT) }}</td>
                                    <td>{{ $faker->randomElement($invoiceTypes) }}</td>
                                    <td>{{ $faker->sentence(3) }}</td>
                                    <td>{{ $faker->date('Y-m-d') }}</td>
                                    <td>{{ number_format($faker->randomFloat(2, 500, 5000), 2) }}</td>
                                    <td>{{ number_format($faker->randomFloat(2, 100, 2000), 2) }}</td>
                                    <td>{{ number_format($faker->randomFloat(2, 100, 2000), 2) }}</td>
                                    <td>{{ number_format($faker->randomFloat(2, 50, 500), 2) }}</td>
                                    <td>
                                        <span
                                            class="badge badge-{{ $status === 'Draft' ? 'warning' : ($status === 'Invoiced' ? 'info' : ($status === 'Paid' ? 'success' : 'danger')) }} d-inline-flex align-items-center badge-xs">
                                            <i class="ti ti-point-filled me-1"></i>{{ $status }}
                                        </span>
                                    </td>
                                    <td>
