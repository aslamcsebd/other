                ...
                <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent-3">
                    <div class="row w-100 mx-auto text-center">
                        <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto w-100">
                            <img src="{{asset('build/assets/images/media/pngs/3.png')}}"
                                        ...
                                        <div class="card-sigin">
                                            <div class="main-signup-header">
                                                ...
                                                <form>
                                                    ...
                                                    <a href="{{url('index')}}"  class="btn btn-primary btn-block w-100">Send</a>
                                                </form>
                                                <div class="main-signin-footer mt-3">
                                                    <p>Forget it, <a href="{{url('forgot')}}"> Send me back</a> to the sign in screen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
