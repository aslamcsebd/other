...
@section('content')
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="my-auto">
                            <h5 class="page-title fs-21 mb-1">Cards</h5>
                            <nav>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <h6 class="card-subtitle fw-semibold mb-2">Special title treatment</h6>
                                ...
                                <div class="col">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">With supporting text below as a natural
                                                lead-in to additional content.</p>
                                            <a href="javascript:void(0);" class="btn btn-info">Purchase</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                    ...
                    <div class="row">
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    If you are going to use, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators.Lorem Ipsum is therefore always free.
                                </div>
                                <div class="card-footer">
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card text-center">
                                <div class="card-header d-flex align-items-center">
                                    <span class="ms-auto fs-17"><i class="ri-heart-fill text-danger"></i></span>
                                </div>
                                <div class="card-body pt-1">
                                    ...
                                    <p class="mb-4 text-muted fs-12">Web Developer</p>
                                    <div class="btn-list">
                        ...
                        <div class="col-xl-2">
                            <div class="card custom-card">
                                <div class="card-body">
                                    <img src="{{asset('build/assets/images/media/media-5.jpg')}}" class="card-img mb-3" alt="...">
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card text-center">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-outline-danger mt-2">Close</a>
                                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                <div class="card-header d-flex align-items-center justify-content-between flex-wrap">
                                    <div class="card-title mb-0 text-wrap text-break">
                                        Card With Fullscreen Button
                                    </div>
                                    <a href="javascript:void(0);" data-bs-toggle="card-fullscreen" class="flex-shrink-0 ms-3">
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card custom-card overlay-card">
                                <img src="{{asset('build/assets/images/media/media-84.jpg')}}" class="card-img" alt="...">
                                <div class="card-img-overlay d-flex flex-column p-0">
                                    ...
                                    <div class="card-body text-fixed-white overflow-scroll">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card overlay-card">
                                <img src="{{asset('build/assets/images/media/media-83.jpg')}}" class="card-img" alt="...">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card overlay-card">
                                <img src="{{asset('build/assets/images/media/media-82.jpg')}}" class="card-img" alt="...">
                                <div class="card-img-overlay d-flex flex-column p-0">
                                    <div class="card-header">
                                        <div class="card-title text-fixed-white">
                                            Image Overlays Are Awesome!
                                    ...
                                    <div class="card-body text-fixed-white">
                                        <div class="card-text">There are many variations of passages of Lorem Ipsum available.</div>
                                    </div>
                                    <div class="card-footer text-fixed-white">Last updated 3 mins ago</div>
                                </div>
                              </div>
                                ...
                                <div class="row g-0">
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <div class="card-subtitle fw-medium mb-3">Horizontal cards are awesome!</div>
                    ...
                    <div class="row">
                        <div class="col-xxl-3 col-xl-12">
                            <div class="card custom-card">
                                ...
                                <img src="{{asset('build/assets/images/media/media-23.jpg')}}" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h6 class="card-title fw-semibold mb-0 lh-1">Forests are Awesome.</h6>
                                    <span class="fs-13">Forests cover a significant area of the earth.</span>
                                </div>
                            </div>
                        </div>
