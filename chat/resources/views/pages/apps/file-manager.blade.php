...
@section('content')
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="my-auto">
                            <h5 class="page-title fs-21 mb-1">File Manager</h5>
                            <nav>
					...
					<div class="row">
						<div class="col-lg-4 col-xl-3">
							<div class="card">
								<div class="main-content-left main-content-left-mail card-body">
									...
									<div class="card mt-3 pb-0 mb-0 shadow-none">
										<div class="card-header fw-bold"><i class="fe fe-hard-drive me-2"></i>Storage</div>
										<div class="card-body pt-0">
											...
											<div class="text-muted fw-medium fs-13 mb-1">26.24 GB Used of 128GB</div>
											<div class="fs-13 text-primary fw-medium">Upgrade Storage</div>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-8 col-xl-9">
							...
							<div class="text-muted mb-2 fs-16">All Files</div>
							<div class="row">
								<div class="col-md-6 col-xl-3">
									<div class="card">
										<a href="{{url('file-manager-list')}}">
											<div class="card-body">
												<div class="fs-16 d-flex align-items-center flex-wrap">
													...
													Image
													<div class="ms-auto fs-13 text-muted">14.2 mb</div>
												</div>
											</div>
										</a>
									</div>
										...
										<a href="{{url('file-manager-list')}}">
											<div class="card-body">
												<div class="fs-16 d-flex align-items-center flex-wrap">
													...
													Video
													<div class="ms-auto fs-13 text-muted">212 mb</div>
												</div>
											</div>
										</a>
									</div>
										...
										<a href="{{url('file-manager-list')}}">
											<div class="card-body">
												<div class="fs-16 d-flex align-items-center flex-wrap">
													...
													Docs
													<div class="ms-auto fs-13 text-muted">34 mb</div>
												</div>
											</div>
										</a>
									</div>
										...
										<a href="{{url('file-manager-list')}}">
											<div class="card-body">
												<div class="fs-16 d-flex align-items-center flex-wrap">
													...
													Music
													<div class="ms-auto fs-13 text-muted">1.5 gb</div>
												</div>
											</div>
										</a>
									</div>
										...
										<a href="{{url('file-manager-list')}}">
											<div class="card-body">
												<div class="fs-16 d-flex align-items-center flex-wrap">
													...
													APK
													<div class="ms-auto fs-13 text-muted">550 mb</div>
												</div>
											</div>
										</a>
									</div>
										...
										<a href="{{url('file-manager-list')}}">
											<div class="card-body">
												<div class="fs-16 d-flex align-items-center flex-wrap">
													...
													Downloads
													<div class="ms-auto fs-13 text-muted">1.8 mb</div>
												</div>
											</div>
										</a>
									</div>
										...
										<a href="{{url('file-manager-list')}}">
											<div class="card-body">
												<div class="fs-16 d-flex align-items-center flex-wrap">
													...
													More
													<div class="ms-auto fs-13 text-muted">16 Gb</div>
												</div>
											</div>
										</a>
									</div>
										...
										<div class="card p-0 ">
											<div class="d-flex align-items-center px-3 pt-3 pb-1">
												<label class="custom-control form-checkbox mb-0">
													<input type="checkbox" class="form-check-input" name="example-checkbox2" value="option2">
											...
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 fw-semibold fs-14">videos</h6>
									...
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card p-0 ">
											...
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 fw-semibold fs-14">Images</h6>
									...
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card p-0 ">
											...
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 fw-semibold fs-14">Sea</h6>
									...
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card p-0 ">
											...
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 fw-semibold fs-14">Downloads</h6>
									...
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card p-0 ">
											...
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 fw-semibold fs-14">document.pdf</h6>
									...
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card p-0 ">
											...
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 fw-semibold fs-14">Word document</h6>
												<span class="text-muted">23kb</span>
											</div>
										</div>
									</div>
									...
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card p-0 ">
											...
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 fw-semibold fs-14">Outdoor Image</h6>
												<span class="text-muted">23kb</span>
											</div>
										</div>
									</div>
