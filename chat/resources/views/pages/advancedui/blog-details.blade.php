...
@section('content')
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="my-auto">
                            <h5 class="page-title fs-21 mb-1">Blog Details</h5>
                            <nav>
                        ...
                        <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12">
                            <div class="card overflow-hidden">
                                <div class="item7-card-img px-4 pt-4">
                                    ...
                                    <img src="{{asset('build/assets/images/media/media-85.jpg')}}" alt="img" class="cover-image rounded-3 w-100">
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-footer pb-2 pt-2">
                                    <div class="item7-card-desc d-md-flex">
                                        <div class="d-flex align-items-center mt-0">
                                            <img src="{{asset('build/assets/images/faces/2.jpg')}}" class="avatar rounded-circle avatar-md me-3" alt="avatar-img">
                                            <div>
                                        ...
                                        <a href="javascript:void(0);" class="me-3 mb-2 d-flex"><span class="fe fe-calendar text-muted me-2 fs-17"></span><div class="mt-0 mt-0 text-dark">Jan-18-2020</div></a>
                                        <a class="me-0 d-flex" href="javascript:void(0);"><span class="fe fe-message-square text-muted me-2 fs-17"></span><div class="mt-0 mt-0 text-dark">12 Comments</div></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-sm-flex mt-0 p-3 sub-review-section border border-bottom-0 br-bl-0 br-br-0">
                                            <div class="d-flex me-3">
                                                <a href="javascript:void(0);"><img class="media-object rounded-circle avatar" alt="64x64" src="{{asset('build/assets/images/faces/1.jpg')}}"> </a>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="mt-0 mb-1 font-weight-semibold">Joanne Scott
                                                    <span class="fs-14 ms-0" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-original-title="verified"><i class="fe fe-check-circle text-success fs-12"></i></span>
                                                    <span class="fs-14 ms-2 d-inline-block"> 4.5 <i class="fa fa-star text-warning"></i></span>
                                                </h6>
                                                <p class="font-13  mb-2 mt-2">
                                                    Lorem ipsum dolor sit amet, quis Neque porro quisquam est, nostrud exercitation ullamco laboris   commodo consequat.
                                                </p>
                                                <a href="javascript:void(0);" class="me-2 mt-1"><span class="badge bg-primary"><span class="me-1 fe fe-thumbs-up fs-11"></span>Helpful</span></a>
                                                <a href="javascript:void(0);" class="me-2 mt-1"><span class="badge bg-success "><span class="me-1 fe fe-edit-2 fs-11"></span>Comment</span></a>
                                                <a href="javascript:void(0);" class="me-2 mt-1"><span class="badge bg-success"><span class="me-1 fe fe-alert-triangle fs-11"></span>Report</span></a>
                                                <div class="btn-group btn-group-sm mb-1 ms-auto float-sm-end mt-1">
                                                    <button class="btn btn-light me-2" ><span class="fe fe-thumbs-up fs-15"></span></button>
                                                    <button class="btn btn-light" ><span class="fe fe-thumbs-down fs-15"></span></button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-sm-flex p-3 sub-review-section border subsection-color br-tl-0 br-tr-0">
                                            <div class="d-flex me-3">
                                                <a href="javascript:void(0);"><img class="media-object rounded-circle avatar" alt="64x64" src="{{asset('build/assets/images/faces/3.jpg')}}"> </a>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="mt-0 mb-1 font-weight-semibold">Rose Slater <span class="fs-14 ms-0" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-original-title="verified"><i class="fe fe-check-circle text-success fs-12"></i></span></h6>
                                                <p class="font-13  mb-2 mt-2">
                                        ...
                                        <div class="d-sm-flex p-3 mt-4 border sub-review-section">
                                            <div class="d-flex me-3">
                                                <a href="javascript:void(0);"><img class="media-object rounded-circle avatar" alt="64x64" src="{{asset('build/assets/images/faces/5.jpg')}}"> </a>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="mt-0 mb-1 font-weight-semibold">Edward
                                                <span class="fs-14 ms-0" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-original-title="verified"><i class="fe fe-check-circle text-success fs-12"></i></span>
                                                <span class="fs-14 ms-2 d-inline-block"> 4 <i class="fa fa-star text-warning"></i></span>
                                                </h6>
                                                <p class="font-13  mb-2 mt-2">
                                                    Lorem ipsum dolor sit amet, quis Neque porro quisquam est, nostrud exercitation ullamco laboris   commodo consequat.
                                                </p>
                                        ...
                                        <div class="d-sm-flex p-3  mt-4 sub-review-section border subsection-color br-tl-0 br-tr-0">
                                            <div class="d-flex me-3">
                                                <a href="javascript:void(0);"><img class="media-object rounded-circle avatar" alt="64x64" src="{{asset('build/assets/images/faces/6.jpg')}}"> </a>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="mt-0 mb-1 font-weight-semibold">Camila cabello <span class="fs-14 ms-0" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-original-title="verified"><i class="fe fe-check-circle text-success fs-12"></i></span></h6>
                                                <p class="font-13  mb-2 mt-2">
                                                    Lorem ipsum dolor sit amet nostrud exercitation ullamco laboris   commodo consequat.
                                                </p>
                                                <a href="javascript:void(0);" class="me-2 mt-1"><span class="badge bg-primary"><span class="me-1 fe fe-thumbs-up fs-11"></span>Helpful</span></a>
                                    ...
                                    <ul class="list-group mb-0">
                                        <li class="list-group-item d-flex border-0 pt-3 px-0">
                                            ...
                                            <div class="">
                                                ...
                                                <a class="text-default fs-12 font-weight-semibold white-space-nowrap">Explore tourism by visitinig places.</a>
                                        ...
                                        <li class="list-group-item d-flex border-0 px-0">
                                            ...
                                            <div class="">
                                                ...
                                                <a class="text-default  fs-12 font-weight-semibold white-space-nowrap">Beautification courses are available.</a>
                                        ...
                                        <li class="list-group-item d-flex pb-3 border-0 px-0">
                                            ...
                                            <div class="">
                                                ...
                                                <a class="text-default fs-12 font-weight-semibold white-space-nowrap">Music in a peaceful way </a>
                            ...
                            <div class="card overflow-hidden">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <a href="{{asset('build/assets/images/media/media-65.jpg')}}" class="glightbox card shadow-none mb-md-0" data-gallery="gallery1">
                                                <img src="{{asset('build/assets/images/media/media-65.jpg')}}" alt="image" >
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <a href="{{asset('build/assets/images/media/media-36.jpg')}}" class="glightbox card shadow-none mb-md-0" data-gallery="gallery1">
                                                <img src="{{asset('build/assets/images/media/media-36.jpg')}}" alt="image" >
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <a href="{{asset('build/assets/images/media/media-35.jpg')}}" class="glightbox card mb-0" data-gallery="gallery1">
