...
@section('content')
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="my-auto">
                            <h5 class="page-title fs-21 mb-1">Search</h5>
                            <nav>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body ps-0 pe-0 bd-t-0 pt-0">
                                    <div class="main-content-body-profile search-nav-style mb-3">
                                        <nav class="nav main-nav-line border-top">
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <h6 class="fs-13">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
