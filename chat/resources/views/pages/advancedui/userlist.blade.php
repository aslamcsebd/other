...
@section('content')
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="my-auto">
                            <h5 class="page-title fs-21 mb-1">Userlist</h5>
                            <nav>
                                    ...
                                    <div class="table-responsive border border-bottom-0 userlist-table">
                                        <table class="table card-table table-vcenter text-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img alt="avatar" class="rounded-circle avatar-md avatar"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-danger-transparent">Banned</span>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-secondary-transparent">In Active</span>
                                                    </td>
                                                    <td>
                                                        <a href="javascript:void(0);">mila@kunis.com</a>
                                                    </td>
