...
@section('content')
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="my-auto">
                            <h5 class="page-title fs-21 mb-1">Offcanvas</h5>
                            <nav>
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <a class="btn btn-primary mb-1 me-1" data-bs-toggle="offcanvas" href="#offcanvasExample"
...
<!-- Prism Code -->
<pre class="language-html"><code class="language-html">&lt;a class="btn btn-primary mb-1 me-1" data-bs-toggle="offcanvas" href="#offcanvasExample"
    role="button" aria-controls="offcanvasExample"&gt;
    Link with href
&lt;/a&gt;
&lt;button class="btn btn-primary mb-1" type="button" data-bs-toggle="offcanvas"
