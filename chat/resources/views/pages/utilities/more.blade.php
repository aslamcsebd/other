...
@section('content')
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="my-auto">
                            <h5 class="page-title fs-21 mb-1">Additional Content</h5>
                            <nav>
                                ...
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <br>
                                            <div class="float-xl-end p-1 bg-light mt-4">Float  xl
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <p><a class="pe-none" tabindex="-1" aria-disabled="true"><code class="text-primary fw-semibold">This link</code></a>
                                                can
                                                not be clicked.
                                            </p>
                                            <p><a href="#" class="pe-auto"><code class="text-primary fw-semibold">This link</code></a> can be clicked (this is default
                                                behavior).
                                            </p>
                                            <p class="pe-none mb-0"><a tabindex="-1" aria-disabled="true"><code>This link</code></a>
                                                can
                                ...
                                <div class="card-body px-2 px-sm-3">
                                    ...
                                    <div style="height: 100px; background-color: rgba(255,0,0,0.1);" class="d-flex">
                                        <div class="h-25 d-inline-block"
                                            style="width: 120px; background-color: rgba(0,0,255,.1);padding-inline:10px;"><span class="d-none d-sm-block">Height</span><span class="d-sm-none">Ht</span> 25%
                                        </div>
                                        <div class="h-50 d-inline-block"
                                            style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;"><span class="d-none d-sm-block">Height</span><span class="d-sm-none">Ht</span> 50%
                                        </div>
                                        <div class="h-75 d-inline-block"
                                            style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;"><span class="d-none d-sm-block">Height</span><span class="d-sm-none">Ht</span> 75%
                                        </div>
                                        <div class="h-100 d-inline-block"
                                            style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;"><span class="d-none d-sm-block">Height</span><span class="d-sm-none">Ht</span> 100%
                                        </div>
                                        <div class="h-auto d-inline-block"
                                            style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;"><span class="d-none d-sm-block">Height</span><span class="d-sm-none">Ht</span> auto
                                        </div>
                                    </div>
                                </div>
                            </div>
