...
@section('content')
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="my-auto">
                            <h5 class="page-title fs-21 mb-1">Badge</h5>
                            <nav>
                                ...
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <span class="icon-badges me-5 m-2">
                                            ...
                                            <span class="badge border bg-light text-default custom-badge me-5 m-2"><i class="fe fe-eye me-2 d-inline-block"></i>13.2k</span>
