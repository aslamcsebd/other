...
@section('content')
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="my-auto">
                            <h5 class="page-title fs-21 mb-1">Images & Figures</h5>
                            <nav>
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body d-flex justify-content-between gap-2">
                                    <figure class="figure">
                                        <img class="figure-img img-fluid rounded card-img" src="{{asset('build/assets/images/media/media-56.jpg')}}" alt="...">
                                        <figcaption class="figure-caption">A caption for the above image.
                                        </figcaption>
                                    </figure>
                                    <figure class="figure float-end">
                                        <img class="figure-img img-fluid rounded card-img" src="{{asset('build/assets/images/media/media-57.jpg')}}" alt="...">
