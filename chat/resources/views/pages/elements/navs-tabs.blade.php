...
@section('content')
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="my-auto">
                            <h5 class="page-title fs-21 mb-1">Navs & tabs</h5>
                            <nav>
                                    ...
                                    <nav class="nav nav-style-1 nav-pills mb-3" role="tablist">
                                        ...
                                        <a class="nav-link active" data-bs-toggle="tab" role="tab" href="#nav-cart"
                                            aria-selected="true">Cart <span
                                                class="badge bg-info ms-1 rounded-pill">32</span></a>
                                                ...
                                                <table class="table mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <th scope="row">
                                                                <span class="avatar avatar-sm">
                                                                    <img src="{{asset('build/assets/images/ecommerce/03.jpg')}}" alt="img">
                                                                </span>
                                                            </th>
                                                            <td>Stop Watch</td>
                                                            <td>Clocks</td>
                                                        ...
                                                        <tr>
                                                            <th scope="row">
                                                                <span class="avatar avatar-sm">
                                                                    <img src="{{asset('build/assets/images/ecommerce/04.jpg')}}" alt="img">
                                                                </span>
                                                            </th>
                                                            <td>Camera</td>
                                                            <td>Gadgets</td>
                                                        ...
                                                        <tr>
                                                            <th scope="row">
                                                                <span class="avatar avatar-sm">
                                                                    <img src="{{asset('build/assets/images/ecommerce/06.jpg')}}" alt="img">
                                                                </span>
                                                            </th>
                                                            <td>Shoes</td>
                                                            <td>Footwear</td>
                                                    ...
                                                    <div class="d-sm-flex">
                                                        ...
                                                        <div>
                                                            <div class="my-md-auto mt-4 ms-md-3">
                                                                ...
                                                                <p class="text-muted ms-0 mb-2"><span></span><span
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="tab-content mt-3 mt-md-0">
