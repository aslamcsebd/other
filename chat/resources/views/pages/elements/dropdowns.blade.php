...
@section('content')
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="my-auto">
                            <h5 class="page-title fs-21 mb-1">Dropdowns</h5>
                            <nav>
                    ...
                    <div class="row">
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <p class="mb-3">Use <code>.dropdown-center</code> on the parent element.
                                    </p>
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <p class="mb-3">Use <code>.dropup-center</code>
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <p class="mb-3">You can use <code>&lt;a&gt;</code> or <code>&lt;button&gt;</code> as
                                    dropdown items.</p>
                                    <div class="dropdown">
                                        <button class="btn btn-info dropdown-toggle" type="button"
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <p class="mb-3">Use <code>data-bs-offset</code> or <code>data-bs-reference</code> to change
                                ...
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-html"><code class="language-html">&lt;div class="d-flex align-items-center flex-wrap"&gt;
                    ...
                    <div class="row">
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <p class="mb-3">Use <code>.dropdown-item-text.</code> to create non-interactive dropdown items.</p>
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <p class="mb-3">Add a <code>.dropdown-header</code> to label sections of actions in any dropdown menu.</p>
                                    <div class="bd-example">
                                        <ul class="dropdown-menu">
                                            <li>
